...
\subsection{Zookeeper role}
\label{kafka-zookeeper}

The \kafka 'service', or broker, consists of one or more \kafka servers working together to provide the 
publish/subscribe message distribution service.

using a \zookeeper service to coordinate their activity.

It often looks like the \zookeeper service is managing or coordinating 
...
\schemaregistry\footurl{https://www.confluent.io/confluent-schema-registry/}

\subsection{Reliable clouds}
\label{reliable-clouds}

There is a often quoted joke in the IT world along the lines of \textit{"the cloud means other people's computers"}. The problems we encountered with the \eleanor \openstack deployments brought this into focus for us.
